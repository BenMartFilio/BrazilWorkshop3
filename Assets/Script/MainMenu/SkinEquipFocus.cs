...
/// <summary>
/// Panel de focus pour l'�quipement d'un skin cosm�tique.
/// Le GameObject lui-m�me est activ�/d�sactiv� (pas un focusRoot enfant).
/// Apr�s �quipement, invoque onEquippedCallback pour que les boutons boutique
/// puissent rafra�chir leur �tat.
/// </summary>
public class SkinEquipFocus : MonoBehaviour
{
    private const float DUREE_ANIM = 0.3f;
    private const float ALPHA_OVERLAY = 0.95f;
    ...
    [SerializeField] private TMP_Text labelDejaEquipe;   // texte "�quip�" visible quand d�j� �quip�
    ...
    /// <summary>
    /// Ouvre le panel depuis l'ic�ne source du bouton boutique.
    /// onEquippedCallback : appel� apr�s �quipement pour rafra�chir les boutons.
    /// </summary>
                       ...
                       System.Action onEquippedCallback = null)
    {
        ...
        // Active le GO avant tout � n�cessaire pour que les coroutines tournent
    ...
    /// <summary>Ferme le panel imm�diatement sans �quiper.</summary>
    public void Fermer()
    {
        if (!_ouvert) return;
        if (_coroutineAnim != null) StopCoroutine(_coroutineAnim);
